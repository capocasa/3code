...
const KnownGoodCombos*: seq[KnownGoodCombo] = @[
    ...
    # venice (aggregator; bare ids with dashes instead of dots/slashes,
    # e.g. zai-org-glm-5-2 for GLM-5.2, kimi-k2-6 for Kimi K2.6.
    # Context windows and function-calling support from the live
    # /models catalog; the e2ee-* TEE variants don't support function
    # calling and are left out on purpose.)
    ("venice",    "zai-org-glm-4.7",        "glm",     "4",   "7",         "on",     0.2, 8192, false, 198_000),
    ("venice",    "zai-org-glm-4.7-flash",  "glm",     "4",   "flash",     "on",     0.2, 8192, false, 128_000),
    ("venice",    "zai-org-glm-5",          "glm",     "5",   "",          "on",     0.2, 8192, false, 198_000),
    ...
    ("venice",    "deepseek-v3.2",          "deepseek", "3.2", "",         "medium", 0.2, 8192, false, 160_000),
    ("venice",    "deepseek-v4-flash",      "deepseek", "4",   "flash",    "low",    0.2, 8192, false, 1_000_000),
    ("venice",    "deepseek-v4-pro",        "deepseek", "4",   "pro",      "low",    0.2, 8192, false, 1_000_000),
    ("venice",    "kimi-k2-5",              "kimi",    "2",   "5",         "on",     0.6, 8192, false, 256_000),
    ("venice",    "kimi-k2-6",              "kimi",    "2",   "6",         "on",     0.6, 8192, false, 256_000),
    ("venice",    "kimi-k2-7-code",         "kimi",    "2",   "7-code",    "on",     0.6, 8192, false, 256_000),
    ("venice",    "kimi-k3",                "kimi",    "3",   "",          "on",     0.6, 8192, false, 1_000_000),
    ("venice",    "kimi-k3-fast-api",       "kimi",    "3",   "fast-api",  "on",     0.6, 4096, false, 1_000_000),
    ("venice",    "minimax-m25",            "minimax", "2",   "5",         "low",    0.2, 8192, false, 198_000),
    ("venice",    "minimax-m27",            "minimax", "2",   "7",         "on",     0.2, 8192, false, 198_000),
    ("venice",    "minimax-m3-preview",     "minimax", "3",   "preview",  "on",     0.2, 8192, false, 524_288),
    ...
    ("venice",    "inkling",                "inkling", "1",   "",         "medium", 0.2, 8192, false, 524_288),
    ("venice",    "openai-gpt-oss-120b",    "gpt-oss", "",    "120b",      "medium", 0.2, 8192, false, 128_000),
    ("venice",    "openai-gpt-52",          "gpt",     "",    "52",        "medium", 0.2, 8192, false, 256_000),
    ("venice",    "openai-gpt-54",          "gpt",     "",    "54",        "medium", 0.2, 8192, false, 1_000_000),
    ("venice",    "openai-gpt-54-mini",     "gpt",     "",    "54-mini",   "medium", 0.2, 4096, false, 400_000),
    ("venice",    "openai-gpt-54-pro",      "gpt",     "",    "54-pro",    "high",   0.2, 8192, false, 1_000_000),
    ("venice",    "openai-gpt-55",          "gpt",     "",    "55",        "medium", 0.2, 8192, false, 1_000_000),
    ("venice",    "openai-gpt-55-pro",      "gpt",     "",    "55-pro",    "high",   0.2, 8192, false, 1_000_000),
    ("venice",    "openai-gpt-56-luna",     "gpt",     "",    "56-luna",   "medium", 0.2, 4096, false, 1_000_000),
    ("venice",    "openai-gpt-56-sol",      "gpt",     "",    "56-sol",    "medium", 0.2, 8192, false, 1_000_000),
    ("venice",    "openai-gpt-56-terra",    "gpt",     "",    "56-terra",  "medium", 0.2, 4096, false, 1_000_000),

    # cheaperinference (aggregator; bare first-party ids on the wire,
    # e.g. glm-5.2, kimi-k3, gpt-5.4. OpenAI-compatible at
    # https://api.cheaperinference.com/v1. The live catalog needs an
    # API key, so only the families documented on the site are listed.)
    ...
    ("cheaperinference", "kimi-k2.6",        "kimi",    "2",   "6",         "on",     0.6, 8192, false, 262_144),
    ("cheaperinference", "kimi-k2.7-code",   "kimi",    "2",   "7-code",    "on",     0.6, 8192, false, 262_144),
    ("cheaperinference", "kimi-k3",          "kimi",    "3",   "",          "on",     0.6, 8192, false, 1_000_000),
    ("cheaperinference", "minimax-m3",       "minimax", "3",   "",         "on",     0.2, 8192, false, 1_000_000),
    ("cheaperinference", "mimo-v2.5",        "mimo",    "2.5", "",         "on",     0.2, 8192, false, 1_000_000),
    ...
    ("cheaperinference", "gpt-5.6",          "gpt",     "",    "5.6",       "medium", 0.2, 8192, false, 400_000),
