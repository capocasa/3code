...
const KnownGoodCombos*: seq[KnownGoodCombo] = @[
    ...
    ("cerebras", "zai-glm-4.7", "glm", "4", "7", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ...
    ("nvidia", "z-ai/glm-5.2", "glm", "5", "2", "high", 0.2, 8192, tbAllTurns,true, 1_000_000, false),
    ("deepinfra", "zai-org/GLM-4.7-Flash", "glm", "4", "flash", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ...
    ("nvidia", "openai/gpt-oss-120b", "gpt-oss", "", "120b", "medium", 0.2, 8192, tbNone, false, 131_072, false),
    ...
    ("together", "deepseek-ai/DeepSeek-V4-Pro", "deepseek", "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1_000_000, true),
    ...
    ("nvidia", "minimaxai/minimax-m3", "minimax", "3", "", "on", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("deepinfra", "MiniMaxAI/MiniMax-M2.7", "minimax", "2", "7", "on", 0.2, 8192, tbNone, false, 204_800, false),
    ...
    ("deepinfra", "moonshotai/Kimi-K2.5", "kimi", "2", "5", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ...
    ("xai", "grok-4.6-latest", "grok", "4", "6-latest", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ("xai", "grok-4.5", "grok", "4", "5", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ("xai", "grok-4.5-latest", "grok", "4", "5-latest", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ("xai", "grok-4.3", "grok", "4", "3", "low", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("xai", "grok-4.3-latest", "grok", "4", "3-latest", "low", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("xai", "grok-build-0.1", "grok", "build", "0.1", "low", 0.2, 8192, tbNone, false, 256_000, false),
    ("xai", "grok-4.20", "grok", "4", "20", "low", 0.2, 8192, tbNone, false, 2_000_000, false),
    ("xai", "grok-4.20-reasoning", "grok", "4", "20-r", "low", 0.2, 8192, tbNone, false, 2_000_000, false),
    ("xai", "grok-4.20-multi-agent", "grok", "4", "20-ma", "high", 0.2, 8192, tbNone, false, 2_000_000, false),
    ...
    ("nanogpt", "TEE/glm-4.7", "glm", "4", "7", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ...
    ("opencode", "deepseek-v4-flash-free", "deepseek", "4", "flash-free", "low", 0.2, 65536, tbAllTurns, false, 1_000_000, false),
    ...
    ("opencodego", "hy3-preview", "hy", "3", "preview", "no_think", 0.2, 8192, tbNone, false, 262_144, false),
    ...
    ("opencodego", "glm-5", "glm", "5", "", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ...
    ("kimicode", "kimi-k2.6", "kimi", "2", "6", "on", -1.0, 8192, tbAllTurns, false, 262_144, false),
    ...
    ("cheaperinference", "grok-4.6", "grok", "4", "6", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ...
    ("crof", "deepseek-v3.2", "deepseek", "3.2", "", "medium", 0.2, 8192, tbAllTurns, false, 128_000, false),
    ("crof", "deepseek-v4-flash", "deepseek", "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 1_000_000, false),
    ("crof", "deepseek-v4-flash-0731", "deepseek", "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 1_000_000, false),
    ("crof", "deepseek-v4-pro", "deepseek", "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1_000_000, false),
    ("crof", "deepseek-v4-pro-0813", "deepseek", "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1_000_000, false),
    ("crof", "glm-5.1", "glm", "5", "1", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ("crof", "glm-5.2", "glm", "5", "2", "high", 0.2, 8192, tbAllTurns, false, 1_000_000, false),
    ("crof", "kimi-k2.6", "kimi", "2", "6", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ("crof", "kimi-k2.7-code", "kimi", "2", "7-code", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ("crof", "kimi-k3", "kimi", "3", "", "on", 0.6, 8192, tbAllTurns, false, 1_000_000, false),
    ("crof", "mimo-v2.5-pro", "mimo", "2.5", "pro", "on", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("crof", "qwen3.5-9b", "qwen", "3.5", "9b", "on", 0.2, 4096, tbNone, false, 262_144, false),
    ("crof", "qwen3.6-27b", "qwen", "3.6", "27b", "on", 0.2, 8192, tbNone, false, 128_000, false),
    ("nvidia", "poolside/laguna-xs-2.1", "laguna", "2", "xs", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ("nvidia", "thinkingmachines/inkling", "inkling", "1", "", "medium", 0.2, 8192, tbNone, false, 256_000, false),
    ...
    ("openrouter", "qwen/qwen3.8-max", "qwen", "3.8", "max", "on", 0.2, 8192, tbNone, false, 1_000_000, false),
    ...
    ("fireworks", "accounts/fireworks/models/deepseek-v4-flash", "deepseek", "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 1_000_000, true),
    ("fireworks", "accounts/fireworks/models/gpt-oss-20b", "gpt-oss", "", "20b", "medium", 0.2, 4096, tbNone, false, 131_072, true),
    ...
    ("groq", "qwen/qwen3.6-27b", "qwen", "3.6", "27b", "on", 0.2, 8192, tbNone, false, 128_000, false),
    ...
    ("hetzner", "GLM-5.2-NVFP4", "glm", "5", "2", "high", 0.2, 8192, tbAllTurns, false, 512_000, false),
    ("hetzner", "DeepSeek-V4-Flash-0731", "deepseek", "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 512_000, false),
    ("hetzner", "Kimi-K2.7-Code", "kimi", "2", "7-code", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ...
    ("aki", "kimi-k2.7-code-1100b", "kimi", "2", "7-code", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ("aki", "minimax-m2.5-230b", "minimax", "2", "5", "low", 0.2, 8192, tbNone, false, 204_800, false),
    ("aki", "qwen3.6-chat-35b", "qwen", "3.6", "35b-a3b", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ("aki", "qwen3.8-chat-27b", "qwen", "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128_000, false),
    ...
    ("opencode", "ling-3.0-flash-free", "ling", "3", "0-flash-f", "off", 0.2, 8192, tbNone, false, 262_144, false),
    ("opencode", "mimo-v2.5-free", "mimo", "2.5", "free", "on", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("opencode", "laguna-s-2.1-free", "laguna", "2", "s-free", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ...
    ("nanogpt", "TEE/gpt-oss-20b", "gpt-oss", "", "20b", "medium", 0.2, 4096, tbNone, false, 131_072, false),
    ("nanogpt", "TEE/kimi-k3", "kimi", "3", "", "on", 0.6, 8192, tbAllTurns, false, 1_000_000, false),
    ("nanogpt", "TEE/minimax-m2.5", "minimax", "2", "5", "low", 0.2, 8192, tbNone, false, 204_800, false),
    ("nanogpt", "alibaba/qwen3.6-27b", "qwen", "3.6", "27b", "on", 0.2, 8192, tbNone, false, 128_000, false),
    ...
    ("opencodego", "longcat-2.0", "longcat"   , "2", "", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ...
    ("nanogpt", "poolside/laguna-m.1", "laguna", "2", "m", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ("nanogpt", "poolside/laguna-s-2.1", "laguna", "2", "s", "on", 0.2, 8192, tbNone, false, 1_000_000, false),
    ("nanogpt", "qwen-3.6-plus", "qwen", "3.6", "plus", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ("nanogpt", "qwen3.7-max", "qwen", "3.7", "max", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ("nanogpt", "qwen3.7-plus", "qwen", "3.7", "plus", "on", 0.2, 8192, tbNone, false, 262_144, false),
    ...
    ("nanogpt", "zai-org/glm-4.7", "glm", "4", "7", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ("nanogpt", "zai-org/glm-4.7-flash", "glm", "4", "flash", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ("nanogpt", "zai-org/glm-5", "glm", "5", "", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ("nanogpt", "zai-org/glm-5.1", "glm", "5", "1", "on", 0.2, 8192, tbAllTurns, false, 200_000, false),
    ("nanogpt", "zai-org/glm-5.2", "glm", "5", "2", "high", 0.2, 8192, tbAllTurns, false, 1_000_000, false),
    ("cheaperinference", "glm-5.3-flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("cheaperinference", "glm-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("nanogpt",   "zai-org/glm-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("nanogpt",   "z-ai/glm-5.3-flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("tensorx",   "z-ai/glm-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("tensorx",   "z-ai/glm-5.3-flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("novita",    "zai-org/glm-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, true),
    ("deepinfra", "zai-org/GLM-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("openrouter", "z-ai/glm-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("together",  "zai-org/GLM-5.3-Flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, true),
    ("together",  "zai-org/GLM-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, true),
    ("nebius",    "zai-org/GLM-5.3-Flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("baseten",   "zai-org/GLM-5.3", "glm"       , "5", "3", "high", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("baseten",   "zai-org/GLM-5.3-Flash", "glm"       , "5", "3-flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("opencodego", "gpt-5.6-luna", "gpt", "", "5.6-luna", "medium", 0.2, 4096, tbNone, false, 400_000, false),
    ("cheaperinference", "gpt-5-mini", "gpt"       , "", "5-mini", "medium", 0.2, 4096, tbNone, false, 400000, false),
    ("cheaperinference", "gpt-5.4-nano", "gpt"       , "", "5.4-nano", "medium", 0.2, 4096, tbNone, false, 400000, false),
    ("opencode",  "gpt-5.4-nano", "gpt"       , "", "5.4-nano", "medium", 0.2, 4096, tbNone, false, 400000, false),
    ("nanogpt",   "openai/gpt-5.4-nano", "gpt"       , "", "5.4-nano", "medium", 0.2, 4096, tbNone, false, 400000, false),
    ("openrouter", "openai/gpt-5.4-nano", "gpt"       , "", "5.4-nano", "medium", 0.2, 4096, tbNone, false, 400000, false),
    ("opencodego", "grok-4.6", "grok", "4", "6", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ("opencodego", "grok-4.5", "grok", "4", "5", "high", 0.2, 8192, tbNone, false, 500_000, false),
    ("opencodego", "hy3", "hy", "3", "", "no_think", 0.2, 8192, tbNone, false, 262_144, false),
    ("opencodego", "kimi-k2.5", "kimi", "2", "5", "on", 0.6, 8192, tbAllTurns, false, 262_144, false),
    ...
    ("cheaperinference", "deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ("cheaperinference", "deepseek-v4-flash-0731", "deepseek"  , "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("venice",    "deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ("nvidia",    "deepseek-ai/deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ("nanogpt",   "deepseek/deepseek-v4-flash-vision-exp", "deepseek"  , "4", "flash-vis", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("tensorx",   "deepseek/deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ("novita",    "deepseek/deepseek-v3.2", "deepseek"  , "3.2", "", "medium", 0.2, 8192, tbAllTurns, false, 128000, true),
    ("novita",    "deepseek/deepseek-v4-flash-vision-exp", "deepseek"  , "4", "flash-vis", "low", 0.2, 65536, tbAllTurns, false, 1000000, true),
    ("novita",    "deepseek/deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, true),
    ("deepinfra", "deepseek-ai/DeepSeek-V4-Pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ("openrouter", "deepseek/deepseek-v4-flash-vision-exp", "deepseek"  , "4", "flash-vis", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("fireworks", "accounts/fireworks/models/deepseek-v4-pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, true),
    ("deepseek",  "deepseek-v4-flash-vision-exp", "deepseek"  , "4", "flash-vis", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("together",  "deepseek-ai/DeepSeek-V4-Pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, true),
    ("nebius",    "deepseek-ai/DeepSeek-V4-Flash-0731", "deepseek"  , "4", "flash", "low", 0.2, 65536, tbAllTurns, false, 1000000, false),
    ("baseten",   "deepseek-ai/DeepSeek-V4-Pro-0813", "deepseek"  , "4", "pro", "low", 0.2, 8192, tbAllTurns, false, 1000000, false),
    ...
    ("aki", "gpt-oss-120b", "gpt-oss", "", "120b", "medium", 0.2, 8192, tbNone, false, 131_072, false),
    ("nebius", "MiniMaxAI/MiniMax-M2.5", "minimax", "2", "5", "on", 0.2, 8192, tbNone, false, 204_800, false),
    ("sambanova", "MiniMax-M3", "minimax"   , "3", "", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ...
    ("nvidia",    "moonshotai/kimi-k3", "kimi"      , "3", "", "on", 0.6, 8192, tbAllTurns, false, 262144, false),
    ...
    ("hetzner",   "Qwen3.8-27B", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, false),
    ("nanogpt",   "qwen/qwen3.8-2.4t-a95b", "qwen"      , "3.8", "2.4t-a95b", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen3.8-max", "qwen"      , "3.8", "max", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen3.7-flash", "qwen"      , "3.7", "flash", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen3.8-27b", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, false),
    ("nanogpt",   "TEE/qwen3-8b", "qwen"      , "3", "8b", "on", 0.2, 4096, tbNone, false, 131072, false),
    ("nanogpt",   "alibaba/qwen3.8-flash", "qwen"      , "3.8", "flash", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen/qwen3.5-397b-a17b", "qwen"      , "3.5", "397b-a17b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("nanogpt",   "qwen/qwen3.5-9b", "qwen"      , "3.5", "9b", "on", 0.2, 4096, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-0.8b", "qwen"      , "3.5", "0.8b", "on", 0.2, 4096, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-2b", "qwen"      , "3.5", "2b", "on", 0.2, 4096, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-4b", "qwen"      , "3.5", "4b", "on", 0.2, 4096, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-27b", "qwen"      , "3.5", "27b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-35b-a3b", "qwen"      , "3.5", "35b-a3b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-122b-a10b", "qwen"      , "3.5", "122b-a10b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("nanogpt",   "qwen3.5-flash", "qwen"      , "3.5", "flash", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen/qwen3.5-plus", "qwen"      , "3.5", "plus", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("nanogpt",   "qwen3.6-max-preview", "qwen"      , "3.6", "max-preview", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("tensorx",   "qwen/qwen3.8-2.4t-a95b", "qwen"      , "3.8", "2.4t-a95b", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("tensorx",   "qwen/qwen3.8-27b", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, false),
    ("novita",    "qwen/qwen3.8-max", "qwen"      , "3.8", "max", "on", 0.2, 8192, tbNone, false, 1000000, true),
    ("novita",    "qwen/qwen3.8-2.4t-a95b", "qwen"      , "3.8", "2.4t-a95b", "on", 0.2, 8192, tbNone, false, 1000000, true),
    ("novita",    "qwen/qwen3.8-27b", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, true),
    ("novita",    "qwen/qwen3.8-flash", "qwen"      , "3.8", "flash", "on", 0.2, 8192, tbNone, false, 1000000, true),
    ("novita",    "qwen/qwen3.5-plus", "qwen"      , "3.5", "plus", "on", 0.2, 8192, tbNone, false, 1000000, true),
    ("novita",    "qwen/qwen3.5-9b", "qwen"      , "3.5", "9b", "on", 0.2, 4096, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3.5-122b-a10b", "qwen"      , "3.5", "122b-a10b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3.5-27b", "qwen"      , "3.5", "27b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3.5-35b-a3b", "qwen"      , "3.5", "35b-a3b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3.5-397b-a17b", "qwen"      , "3.5", "397b-a17b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3-coder-30b-a3b-instruct", "qwen"      , "3", "coder-30b-a3b", "on", 0.2, 8192, tbNone, false, 160000, true),
    ("novita",    "qwen/qwen3-coder-480b-a35b-instruct", "qwen"      , "3", "coder-480b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3-coder-next", "qwen"      , "3", "coder-next", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3-max", "qwen"      , "3", "max", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("novita",    "qwen/qwen3-235b-a22b-instruct-2507", "qwen"      , "3", "235b-a22b", "on", 0.2, 8192, tbNone, false, 131072, true),
    ("novita",    "qwen/qwen3-next-80b-a3b-instruct", "qwen"      , "3", "next-80b-a3b", "on", 0.2, 8192, tbNone, false, 131072, true),
    ("deepinfra", "Qwen/Qwen3.8-Max", "qwen"      , "3.8", "max", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("deepinfra", "Qwen/Qwen3.8-2.4T-A95B", "qwen"      , "3.8", "2.4t-a95b", "on", 0.2, 8192, tbNone, false, 1000000, false),
    ("deepinfra", "Qwen/Qwen3.8-27B", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, false),
    ("deepinfra", "Qwen/Qwen3.5-9B", "qwen"      , "3.5", "9b", "on", 0.2, 4096, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3.5-27B", "qwen"      , "3.5", "27b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3.5-35B-A3B", "qwen"      , "3.5", "35b-a3b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3.5-122B-A10B", "qwen"      , "3.5", "122b-a10b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3.5-397B-A17B", "qwen"      , "3.5", "397b-a17b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3-14B", "qwen"      , "3", "14b", "on", 0.2, 4096, tbNone, false, 131072, false),
    ("deepinfra", "Qwen/Qwen3-32B", "qwen"      , "3", "32b", "on", 0.2, 8192, tbNone, false, 131072, false),
    ("deepinfra", "Qwen/Qwen3-30B-A3B", "qwen"      , "3", "30b-a3b", "on", 0.2, 8192, tbNone, false, 131072, false),
    ("deepinfra", "Qwen/Qwen3-Max", "qwen"      , "3", "max", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3-235B-A22B-Instruct-2507", "qwen"      , "3", "235b-a22b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3-Next-80B-A3B-Instruct", "qwen"      , "3", "next-80b-a3b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("deepinfra", "Qwen/Qwen3-Coder-480B-A35B-Instruct-Turbo", "qwen"      , "3", "coder-480b", "on", 0.2, 8192, tbNone, false, 262144, false),
    ("aki",       "qwen3.8-27b", "qwen"      , "3.8", "27b", "on", 0.2, 8192, tbNone, false, 128000, false),
    ("together",  "Qwen/Qwen3.6-35B-A3B-FP8", "qwen"      , "3.6", "35b-a3b", "on", 0.2, 8192, tbNone, false, 262144, true),
    ("together",  "Qwen/Qwen3.8-2.4T-A95B", "qwen"      , "3.8", "2.4t-a95b", "on", 0.2, 8192, tbNone, false, 1000000, true),
    ("together",  "Qwen/Qwen3.8-Flash", "qwen"      , "3.8", "flash", "on", 0.2, 8192, tbNone, false, 1000000, true),
  ]
